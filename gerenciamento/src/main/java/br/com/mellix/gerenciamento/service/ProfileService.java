...
import br.com.mellix.gerenciamento.dto.AuthDTO;
...
import br.com.mellix.gerenciamento.util.JwtUtil;
...
public class ProfileService {
    ...
    public ProfileEntity getCurrentProfile() {
        ...
        return profileRepository.findByEmail(authentication.getName())
                .orElseThrow(() -> new UsernameNotFoundException("Perfil com este email não foi encontrado: "+ authentication.getName()));
    }
    ...
    public ProfileDTO getPublicProfile(String email) {
        ...
        if (email == null) {
            ...
            currentUser = profileRepository.findByEmail(email)
                    .orElseThrow(() -> new UsernameNotFoundException("Perfil com este email não foi encontrado "+ email));
        }
